...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field images on 'ContentBlock'
        m2m_table_name = db.shorten_name(u'website_contentblock_images')
        ...
        db.create_unique(m2m_table_name, ['contentblock_id', 'image_id'])


    def backwards(self, orm):
        # Removing M2M table for field images on 'ContentBlock'
        db.delete_table(db.shorten_name(u'website_contentblock_images'))
