...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'website_linkitem', (
            ...
            ('txtid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ...
        # Adding model 'ResumeItemDetail'
        db.create_table(u'website_resumeitemdetail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.ResumeItem'])),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('hide', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'website', ['ResumeItemDetail'])

        # Adding field 'ResumeItem.hide'
        db.add_column(u'website_resumeitem', 'hide',
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ResumeItemDetail'
        db.delete_table(u'website_resumeitemdetail')

        # Deleting field 'ResumeItem.hide'
        db.delete_column(u'website_resumeitem', 'hide')
    ...
    models = {
        ...
        u'website.linkitem': {
            'Meta': {'ordering': "['order']", 'object_name': 'LinkItem'},
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'hide': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['website.LinkItem']", 'null': 'True', 'blank': 'True'}),
            'path': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'txtid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
