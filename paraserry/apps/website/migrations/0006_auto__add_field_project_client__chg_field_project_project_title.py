...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'website_project', 'client',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Project.project_title'
        db.alter_column(u'website_project', 'project_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'Project.client'
        db.delete_column(u'website_project', 'client')


        # Changing field 'Project.project_title'
        db.alter_column(u'website_project', 'project_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
