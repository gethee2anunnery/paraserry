...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'website_project', 'images')

        # Adding field 'Project.feature_image'
        db.add_column(u'website_project', 'feature_image',
