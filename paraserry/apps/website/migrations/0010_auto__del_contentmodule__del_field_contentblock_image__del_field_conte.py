...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ContentModule'
        db.delete_table(u'website_contentmodule')

        # Deleting field 'ContentBlock.image'
        db.delete_column(u'website_contentblock', 'image_id')

        # Deleting field 'ContentBlock.module'
        db.delete_column(u'website_contentblock', 'module_id')


    def backwards(self, orm):
        # Adding model 'ContentModule'
        db.create_table(u'website_contentmodule', (
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Project'], null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'website', ['ContentModule'])

        # Adding field 'ContentBlock.image'
        db.add_column(u'website_contentblock', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Image'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContentBlock.module'
        db.add_column(u'website_contentblock', 'module',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.ContentModule'], null=True, blank=True),
                      keep_default=False)
